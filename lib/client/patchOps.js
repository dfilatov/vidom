...
function appendChild(parentNode, childNode) {
    parentNode.getDomNode().appendChild(childNode.renderToDom());
    childNode.mount();
}

function insertChild(parentNode, childNode, beforeChildNode) {
    parentNode.getDomNode().insertBefore(childNode.renderToDom(), beforeChildNode.getDomNode());
    childNode.mount();
}
...
function replace(oldNode, newNode) {
    var oldDomNode = oldNode.getDomNode(),
        newDomNode = newNode.renderToDom();
